...
def audio_cut(start_percent,end_percent,*checkbox_list):
    '''裁剪a%到b%音频并保存'''

    if start_percent>=end_percent:return b_change_index(g_index, g_batch)
    ...
    return {"__type__": "update","value": 0},{"__type__": "update","value": 1},*b_change_index(g_index, g_batch)
...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        ...
        btn_audio_cut.click(
            audio_cut,
            inputs=[slider_start,slider_end,*g_checkbox_list],
            outputs=[slider_start,slider_end,*g_text_list, *g_audio_list, *g_checkbox_list]
        )
